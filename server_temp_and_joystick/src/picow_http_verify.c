...
// Usando esta URL, pois sabemos que o certificado raiz não mudará por um bom tempo

#define HOST "fw-download-alias1.raspberrypi.com"
#define URL_REQUEST "/net_install/boot.sig"

// This is the PUBLIC root certific ate exported from a browser
// Note that the newlines are needed
// Este é o certificado raiz PÚBLICO exportado de um navegador
// Note que as quebras de linha são necessárias
...
// Esse é um certificado de teste
...
int main() {
    ...
    // Repita o teste com o certificado errado. Deve falhar
